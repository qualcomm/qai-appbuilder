...
```powershell
# ${APP_ROOT} = QAIModelBuilder repo root (wherever this repo is checked out)
# python_arm64_venv on ARM64 hosts; python_runtime_venv on x64 hosts — read from ${APP_ROOT}\data\config\qairt_env.json
