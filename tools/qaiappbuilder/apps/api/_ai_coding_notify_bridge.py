...
class AiCodingToChannelNotifier:
    ...
    async def wechat_notify(
        ...
        *,
        ...
        """
        q_text = t("channels.ai_coding_notify.sync.question", question=question)
        r_text = t("channels.ai_coding_notify.sync.reply", reply=reply)
    ...
    async def done_push(
        ...
        *,
        ...
        Returns ``True`` on success.
        """
        text = t("channels.ai_coding_notify.task_done.with_summary", summary=summary) if summary else t("channels.ai_coding_notify.task_done.plain")
    ...
    async def turn_warning_sync(
        ...
        *,
        ...
        Mirrors v1's ``turn_warning`` event handling: when the CC/OC
    ...
    async def restore_owner_bind(
        ...
        *,
        ...
        Mirrors v1's ``set_active`` endpoint logic: when a session
