...
class ModelCatalogServices:
    ...
    get_qgenie_quota_use_case: GetQGenieQuotaUseCase
...
def build_model_catalog_services(
    ...
    # cache nothing and burn the upstream's ~60 s budget.
    get_qgenie_quota = GetQGenieQuotaUseCase(
        registry=provider_registry,
        quota=HttpQGenieQuota(
