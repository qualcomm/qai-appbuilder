...
When the user chooses to exit, the supervisor terminates via ``os._exit``,
which bypasses cmd.exe's batch-interrupt check so no
...
# ---------------------------------------------------------------------------
# Console control handler (SetConsoleCtrlHandler)
# ---------------------------------------------------------------------------
