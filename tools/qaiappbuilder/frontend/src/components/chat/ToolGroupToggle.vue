...
const GROUPS: ToolGroup[] = [
  {
    ...
    members: new Set(["read", "glob", "grep", "web_fetch", "web_search", "list", "skill"]),
  },
  {
    id: "edit",
  ...
  {
    id: "orchestration",
    labelKey: "codePersona.groups.orchestration",
    members: new Set(["agent", "sub_agent", "scheduled_task"]),
  },
  {
    id: "planning",
    labelKey: "codePersona.groups.planning",
    members: new Set(["implementation_plan", "todowrite", "question"]),
  },
  {
    id: "appbuilder",
    labelKey: "codePersona.groups.appbuilder",
    members: new Set(["appbuilder_run", "appbuilder_batch_run"]),
  },
  {
    id: "automation",
    labelKey: "codePersona.groups.automation",
    members: new Set(["browser", "computer"]),
  },
  {
    id: "memory",
    labelKey: "codePersona.groups.memory",
    members: new Set(["recall_experience", "remember_experience", "search_conversations"]),
  },
];
