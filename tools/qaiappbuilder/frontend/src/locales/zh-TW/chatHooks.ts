...
const chatHooks = {
  ...
  computer: {
    title: "桌面控制（Computer）",
    subtitle: "允許助手擷取螢幕並操作真實的滑鼠和鍵盤。預設關閉。",
    label: "啟用桌面控制",
    warning:
      "此功能會控制你的真實桌面——擷取與輸入會作用於螢幕上的任何內容。有後果的操作需要你明確確認。",
    savedOn: "已啟用桌面控制",
    savedOff: "已停用桌面控制",
    saveFailed: "儲存桌面控制設定失敗",
  },
  imageCloud: {
    title: "傳雲端圖片格式",
    subtitle: "對傳送到雲端模型的圖片副本重新壓縮。本地原圖不會被修改。",
    formatLabel: "格式",
    qualityLabel: "品質（1-100）",
    saved: "已儲存傳雲端圖片設定",
    saveFailed: "儲存傳雲端圖片設定失敗",
  },
};
