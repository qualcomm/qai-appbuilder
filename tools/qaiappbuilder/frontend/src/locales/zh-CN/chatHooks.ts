...
const chatHooks = {
  ...
  computer: {
    title: "桌面控制（Computer）",
    subtitle: "允许助手截取屏幕并操作真实的鼠标和键盘。默认关闭。",
    label: "启用桌面控制",
    warning:
      "该功能会控制你的真实桌面——截图与输入会作用于屏幕上的任何内容。有后果的操作需要你显式确认。",
    savedOn: "已启用桌面控制",
    savedOff: "已禁用桌面控制",
    saveFailed: "保存桌面控制设置失败",
  },
  imageCloud: {
    title: "发云端图片格式",
    subtitle: "对发送到云端模型的图片副本重新压缩。本地原图不会被修改。",
    formatLabel: "格式",
    qualityLabel: "质量（1-100）",
    saved: "已保存发云端图片设置",
    saveFailed: "保存发云端图片设置失败",
  },
};
