...
const settings = {
  ...
  subtitle: {
    ...
    scheduledTasks: "Scheduled tasks — list, edit content, and set per-task tool / skill permissions",
    search: "Search engines behind the Agent search tool — toggles, measured quality, and API keys",
  },
  tab: {
    agent: "Agent",
    aiCoding: "AI Coding",
