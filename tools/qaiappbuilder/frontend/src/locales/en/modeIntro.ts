...
const modeIntro = {
  ...
  modelHub: {
    ...
    ex2Label: "Download Zipformer for speech recognition",
    ex2Prompt: "Download the pre-compiled Zipformer speech-recognition model from Qualcomm AI Hub and run inference on a sample audio file on the NPU.",
  ...
  pro: {
    ...
    step4: "The Builder status bar can be expanded — handy for reaching the top-row buttons.",
