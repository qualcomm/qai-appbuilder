...
const toolSafety = {
  ...
  layer2Desc:
    "PolicyCenter enforcement of read / write / exec permissions per the active policy. The FileGuard master switch lives in the Overview tab's Security mode control.",
