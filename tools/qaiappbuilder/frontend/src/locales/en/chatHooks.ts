...
const chatHooks = {
  ...
  computer: {
    title: "Computer (Desktop Control)",
    subtitle:
      "Let the assistant capture the screen and drive the real mouse and keyboard. Off by default.",
    label: "Enable desktop control",
    warning:
      "This controls your actual desktop — screenshots and input affect whatever is on screen. Consequential actions require your explicit confirmation.",
    savedOn: "Desktop control enabled",
    savedOff: "Desktop control disabled",
    saveFailed: "Failed to save desktop-control setting",
  },
  imageCloud: {
    title: "Cloud Image Format",
    subtitle:
      "Re-compress image copies sent to the cloud model. The local originals are never modified.",
    formatLabel: "Format",
    qualityLabel: "Quality (1-100)",
    saved: "Cloud image settings saved",
    saveFailed: "Failed to save cloud image settings",
  },
};
