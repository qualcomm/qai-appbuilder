...
* ``web_fetch``       — fetch + extract a URL (markdown / text)
...
from qai.ai_coding.infrastructure.tools.handlers.ast_rewrite import (
    tool_ast_edit,
)
from qai.ai_coding.infrastructure.tools.handlers.ast_search import (
    tool_ast_grep,
)
from qai.ai_coding.infrastructure.tools.handlers.browser import (
    tool_browser,
)
...
from qai.ai_coding.infrastructure.tools.handlers.run_code import tool_run_code
from qai.ai_coding.infrastructure.tools.handlers.scan_secrets import (
    tool_scan_secrets,
)
