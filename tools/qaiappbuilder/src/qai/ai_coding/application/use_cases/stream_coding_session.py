...
_TURN_WARNING_START = 30
_TURN_WARNING_STEP = 10
...
def compute_turn_warning_threshold(turn_count: int) -> int:
    ...
    (``session_manager.py:111-130``): below the floor (30) returns 0; at
    or above it returns the highest crossed tier (30 / 40 / 50 / …).

    Examples: 29→0, 30→30, 39→30, 40→40, 51→50.
    """
