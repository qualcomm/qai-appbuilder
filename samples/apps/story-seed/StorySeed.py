...
RED_APP_DIR = os.path.join(CURRENT_DIR, "apps", "story-seed")
IMAGE_SCRIPT_PATH = os.path.join(CURRENT_DIR, "models", "generative_ai", "image_generation", "stable_diffusion_v2_1", "python", "stable_diffusion_v2_1.py")
IMAGE_GENERATED_PATH = os.path.join(CURRENT_DIR, "models", "generative_ai", "image_generation", "stable_diffusion_v2_1", "images")
