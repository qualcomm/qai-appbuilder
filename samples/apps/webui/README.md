...
> **Important:** Always run the apps from the `samples/` directory, not from `samples/apps/webui/`. The batch files (`start_*.bat`) handle this automatically.
...
**File:** `apps\webui\image-repair\ImageRepairApp.py`  
**Port:** 8977  
...
```
samples\apps\webui\image-repair\start_ImageRepairApp.bat
```
...
**File:** `apps\webui\stable-diffusion\StableDiffusionApp.py`  
**Port:** 8978  
...
4. Save the downloaded `.bin` files to:
   ```
   qai-appbuilder\samples\models\generative_ai\image_generation\stable_diffusion_v2_1\models\
   ```
...
**Option B — Double-click batch file:**
```
samples\apps\webui\stable-diffusion\start_StableDiffusionApp.bat
```
...
- Generated images are saved to `samples\apps\webui\stable-diffusion\images\`.
...
**File:** `apps\webui\genie-chat\GenieWebUI.py`  
...
**Option B — Double-click batch file:**
```
samples\apps\webui\genie-chat\start_GeneWebUI.bat
```
...
| Batch File | App |
|-----------|-----|
| `apps\webui\image-repair\start_ImageRepairApp.bat` | ImageRepairApp |
| `apps\webui\stable-diffusion\start_StableDiffusionApp.bat` | StableDiffusionApp |
| `apps\webui\genie-chat\start_GeneWebUI.bat` | GenieWebUI |
