...
The SuperResolution sample app demonstrates how to upscale an image using [SuperResolution AI models](https://aihub.qualcomm.com/mobile/models?domain=Computer+Vision&useCase=Super+Resolution) on Android mobile devices.<br>
