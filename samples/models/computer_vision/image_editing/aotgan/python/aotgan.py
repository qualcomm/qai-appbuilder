...
sys.path.append(".")
sys.path.append(os.path.join(_SCRIPT_DIR, "..", "..", "..", "..", "..", "shared", "python"))   # for image_processing and install
...
Inference(execution_ws / ".." / "assets" / "input.png", execution_ws / ".." / "assets" / "mask.png", execution_ws / "output.png")
