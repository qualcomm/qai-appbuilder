...
sys.path.append(".")
sys.path.append(os.path.join(_SCRIPT_DIR, "..", "..", "..", "..", "..", "shared", "python"))
...
face_img_fbox_path = execution_ws / ".." / "assets" / "face_img_fbox.txt"
meanFace_path      = execution_ws / ".." / "assets" / "meanFace.npy"
shapeBasis_path    = execution_ws / ".." / "assets" / "shapeBasis.npy"
blendShape_path    = execution_ws / ".." / "assets" / "blendShape.npy"
...
def Inference(input_image_path):
    ...
    np.savetxt(
        execution_ws / ".." / "assets" / "demo_output_lmk.txt",
...
def main(input=None):
    if input is None:
        input = execution_ws / ".." / "assets" / "input.jpg"
