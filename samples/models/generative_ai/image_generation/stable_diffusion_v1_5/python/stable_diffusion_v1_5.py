...
TOKENIZER_HELP_URL      = "https://github.com/qualcomm/qai-appbuilder/blob/main/samples/generativeAI/Image_Generation/stable_diffusion_v1_5/README.md"
MODEL_HELP_URL          = "https://github.com/qualcomm/qai-appbuilder/blob/main/samples/generativeAI/Image_Generation/stable_diffusion_v1_5/README.md"
...
####################################################################
# Model classes (v1.5-specific: TextEncoder outputs 768-dim embeddings)

class TextEncoder(TextEncoderBase):
    _embed_dim = 768   # SD v1.5 text embedding dimension
...
def model_destroy():
    global text_encoder, unet, vae_decoder
    del text_encoder
    del unet
    del vae_decoder
...
if __name__ == "__main__":
    ...
    model_execute(modelExecuteCallback, execution_ws / ".." / "assets" / "images", True, True)
